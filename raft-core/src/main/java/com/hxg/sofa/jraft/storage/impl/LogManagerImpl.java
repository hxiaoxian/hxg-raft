...
import com.hxg.sofa.jraft.error.LogEntryCorruptedException;
...
import com.hxg.sofa.jraft.option.LogStorageOptions;
...
import com.hxg.sofa.jraft.util.SegmentList;
...
public class LogManagerImpl implements LogManager {
    ...
    private Configuration oldConfFromMeta(final RaftOutter.SnapshotMeta meta) {
    ...
    private Configuration confFromMeta(final RaftOutter.SnapshotMeta meta) {
