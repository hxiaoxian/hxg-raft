...
import com.hxg.sofa.jraft.core.TestCluster;
import com.hxg.sofa.jraft.entity.PeerId;
import com.hxg.sofa.jraft.option.CliOptions;
import com.hxg.sofa.jraft.rpc.impl.cli.CliClientServiceImpl;
...
public class RouteTableTest {
    ...
    public void setup() throws Exception {
        ...
        Assert.assertEquals(NodeImpl.GLOBAL_NUM_NODES.get(), 0);
    ...
    public void testUpdateConfSelectLeader() throws Exception {
        ...
        Assert.assertEquals(rt.getConfiguration(groupId), new Configuration(cluster.getPeers()));
        ...
        Assert.assertEquals(leader, cluster.getLeader().getNodeId().getPeerId());
    }
