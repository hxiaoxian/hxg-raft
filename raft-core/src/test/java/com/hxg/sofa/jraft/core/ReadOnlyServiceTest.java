...
public class ReadOnlyServiceTest {
    ...
    public void testAddRequest() throws Exception {
        ...
        Mockito.verify(this.node).handleReadIndexRequest(Mockito.argThat(new ArgumentMatcher<RpcRequests.ReadIndexRequest>() {

            @Override
            public boolean matches(final Object argument) {
                if (argument instanceof RpcRequests.ReadIndexRequest) {
                    final RpcRequests.ReadIndexRequest req = (RpcRequests.ReadIndexRequest) argument;
    ...
    public void testAddRequestOnResponsePending() throws Exception {
        ...
        closure.setResponse(RpcRequests.ReadIndexResponse.newBuilder().setIndex(1).setSuccess(true).build());
