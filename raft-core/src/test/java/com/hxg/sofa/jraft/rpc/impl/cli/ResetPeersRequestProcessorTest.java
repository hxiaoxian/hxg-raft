...
public class ResetPeersRequestProcessorTest extends AbstractCliRequestProcessorTest<CliRequests.ResetPeerRequest> {

    @Override
    public CliRequests.ResetPeerRequest createRequest(String groupId, PeerId peerId) {
        return CliRequests.ResetPeerRequest.newBuilder(). //
            setGroupId(groupId). //
    ...
    @Override
    public BaseCliRequestProcessor<CliRequests.ResetPeerRequest> newProcessor() {
        return new ResetPeerRequestProcessor(null);
    }

    @Override
    public void verify(String interest, Node node, ArgumentCaptor<Closure> doneArg) {
        assertEquals(interest, CliRequests.ResetPeerRequest.class.getName());
