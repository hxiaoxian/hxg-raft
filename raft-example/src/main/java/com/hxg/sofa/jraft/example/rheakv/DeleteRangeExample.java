...
public class DeleteRangeExample {
    ...
    public static void deleteRange(final RheaKVStore rheaKVStore) {
        for (int i = 0; i < 10; i++) {
            rheaKVStore.bPut("delete_range_example_" + i, BytesUtil.writeUtf8("1"));
        }
        final byte[] start = BytesUtil.writeUtf8("delete_range_example_0");
        final byte[] end = BytesUtil.writeUtf8("delete_range_example_9");
