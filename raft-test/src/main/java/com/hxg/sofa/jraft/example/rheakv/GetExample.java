...
public class GetExample {
    ...
    public static void get(final RheaKVStore rheaKVStore) {
        final byte[] key = BytesUtil.writeUtf8("hello");
        final byte[] value = BytesUtil.writeUtf8("world");
        ...
        LOG.info("Async get result={}", BytesUtil.readUtf8(f1.join()));
        LOG.info("Async get result={}", BytesUtil.readUtf8(f2.join()));
        LOG.info("Async get result={}", BytesUtil.readUtf8(f3.join()));
        LOG.info("Async get result={}", BytesUtil.readUtf8(f4.join()));
        ...
        LOG.info("Sync get result={}", BytesUtil.readUtf8(b1));
        LOG.info("Sync get result={}", BytesUtil.readUtf8(b2));
        LOG.info("Sync get result={}", BytesUtil.readUtf8(b3));
        LOG.info("Sync get result={}", BytesUtil.readUtf8(b4));
    }
}
